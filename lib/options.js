...
module.exports = require("nomnom").
    ...
    options(formatHelp({
        ...
        // readStdin: {
        //     string: "-S, --stdin",
        //     help: "Read INPUT_PATH from STDIN instead of a file. The current working directory will be considerd the base directory for resolving requires of the './' variety.",
        //     flag: true
        // },
    
        // watchFile: {
        //     string: "-w, --watch",
        //     help: "Watch INPUT_PATH and any --define-module files. Whenever they are modified, re-infuse with the same command. Implies --force.",
        //     flag: true
        // },
    ...
    help(wordwrap(100)("NOTES:\nIn the case of INPUT_PATH being a directory, if OUTPUT_PATH is a directory each file from INPUT_PATH will be infused and placed in OUTPUT_PATH. If OUTPUT_PATH is a file, all files from INPUT_PATH will be infused and combined into OUTPUT_PATH. If OUTPUT_PATH is meant to be a directory, it must exist first.")).
    parse();
