...
module.exports = Infusion.derive({
    ...
    events: {
        ...
        'complete': function (infuser) {
            ...
            appAst.query('id[name=MODULES]')[0].update({
                type: 'ObjectExpression',
                properties: this.requires.map(this.makeModule, this)
            });
    ...
    rules: {
        'call.callee > id[name="require"]': function (node, infuser) {
            ...
            switch (arg.type) {
            case 'Literal':
                arg.update('value', this.require(arg.value));
                break;
            case 'Identifier':
                // TODO: Use scope and to determine module
                break;
            }
        }
    }
