...
module.exports = Infusion.derive({
    ...
    init: function (opts) {
        ...
        if (typeof this.options.resolve !== 'function') {
            throw new Error('Requires Infusion needs a \'resolve\' function');
        }
        this.pathMap = {};
    ...
    addModule: function (name) {
        var pathMap = this.pathMap,
            ...
            filepath = resolve(name, curAst.directory),
            modules,
            id;
        ...
        modules  = infuser.get(this.REQUIRED_MODULES_LIST_KEY);
    ...
    events: {
        'start': function (infuser) {
            ...
            infuser.set(this.REQUIRED_MODULES_LIST_KEY, []);
        },
        ...
        'complete': function (infuser) {
            ...
            appAst.query('id[name=INFUSE_MODULES]')[0].alter({
                type: 'ObjectExpression',
                properties: modules.sort(function (modA, modB) {
