...
module.exports = Proteus.Class.derive(Object.defineProperties({
    ...
    /**
     * Add an infusion to be used on AST traversal.
     * 
     * @param {Object} infusion
     *      @property {Object} infusion.rules
     *      @property {Object} infusion.events
     * @returns {Number} the index of the added infusion
     */
    use: function (infusion) {
        return (this.infusions.push(infusion) - 1);
    },
    /**
    ...
    get: function (id) {
        ...
        return this.infusions.filter(function (infusion) {
            return infusion.id === id;
        })[0];
    },
    /**
