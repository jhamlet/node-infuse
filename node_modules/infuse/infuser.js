...
module.exports = Proteus.Class.derive(Object.defineProperties({
     ...
     * 
     * @param {Object} obj
     *      @property {Object} obj.rules
     *      @property {Object} obj.events
     * @returns {Number} the index of the added extract
     */
    use: function (obj) {
        return (this.extracts.push(obj) - 1);
    },
    /**
    ...
    exec: function (node) {
        ...
        this.extracts.forEach(function (extract) {
            var rules = extract.rules;
            
            if (rules) {
                Proteus.getPropertyNames(rules).forEach(function (rule) {
                    var query = new NodeQuery(rule);
    ...
    notify: function (msg, node) {
        ...
        this.extracts.forEach(function (extract) {
            ...
            if (events) {
                Proteus.getPropertyNames(events).forEach(function (key) {
