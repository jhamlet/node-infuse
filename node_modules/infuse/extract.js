...
module.exports = Extract = Proteus.Class.derive(Object.defineProperties({
    ...
    self: {
        inherited: function (subclass) {
            ...
            ;
            /**
             * Prototype-link subclass rules with superclass rules
             */
            if (subrules !== protorules) {
                subproto.rules = Proteus.merge(
                    Object.create(protorules),
                    subrules
                );
            }
            /**
             * Prototype-link subclass events with superclass events
             */
            if (subevents !== protoevents) {
                subproto.events = Proteus.merge(
                    Object.create(protoevents),
                    subevents
                );
            }
        }
