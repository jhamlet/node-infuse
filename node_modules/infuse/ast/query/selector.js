...
module.exports = Proteus.Class.derive({
    ...
    self: {
        ...
        TESTS: (TEST_STRATEGIES = {
            ...
            /**
             * Tests to see that the current node is a direct child of it's parent's
             * node named 'attr'
             */
            ...
            /**
             * Tests to see if the current node's parent has the attr and value.
             * Returns the parent node if successful, otherwise false.
             */
