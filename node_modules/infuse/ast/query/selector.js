...
module.exports = Proteus.Class.derive(Object.defineProperties({
    ...
    self: {
        ...
        TESTS: (TEST_STRATEGIES = {
             ...
             */
            "member": function (node, attr) {
                var parent = node.parent,
                    child = parent[attr]
                ;
                
                if (isArray(child) && ~child.indexOf(node) || node === child) {
                    return parent;
                }
            ...
            "sibling": function (node, attr, op, val) {
                var subject = node.parent,
                    childKeys = CHILD_KEYS[subject.type],
                    attrVal,
                    relative
                ;
    ...
    /**
     * This represents the type of the selector.
     * 
     * Once set, it can not be changed.
     * 
     * NOTE: It's a bit of a hack at this time.  It was added to facilitate
     * the 'member' selector type.
     * 
     * @property {String} type
     */
    type: {
        get: function () {
            return this.constructor.TYPES.SELF;
        },
        set: function (t) {
            Object.defineProperty(this, "type", { value: t, enumerable: true });
        },
        enumerable: true
    }
}));