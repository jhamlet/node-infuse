 ...
 * @property {String} Plugin.id
 * 
 * A general grouping by type
 * @property {String} Plugin.type
 * 
 * Run this plugin and return the textual results
 * @property {Function} Plugin.run
 *      @param {String} src
 *      @param {String} opts optional, a string to be parsed for options
 *      @returns {String} the result of the run operation
 */
//---------------------------------------------------------------------------
