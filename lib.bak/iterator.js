...
(function (exports) {
    ...
    module.exports = Iterator = PClass.derive({
        ...
        skipToNode: function (node) {
            var n;
            while (!this.hasTerminated() && node !== (n = this.getCurrent())) {
                crawl.call(this, 1);
            }
            return n;
        },
        ...
        findAll: function (fn) {
            ...
            this.start();
            while (!this.hasTerminated() && this.find(fn)) {
        ...
        findAllNamesOf: function (id) {
            return this.findAll(function (node) {
                return node[0] === "name" && node[1] === id;
            });
        },
